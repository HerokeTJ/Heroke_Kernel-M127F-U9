...
ARCH        ?=arm64
CROSS_COMPILE   ?= $(srctree)/toolchain/arm-gnu-toolchain-14.2.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-
...
CC		= $(srctree)/toolchain/clang/host/linux-x86/clang-12/bin/clang
LD		= $(CROSS_COMPILE)ld
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
